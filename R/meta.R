#' Meta analysis data
#'
#' Data from the meta analysis originally conducted by da Silva Teixeira et al (2022).
...
#'   \item{lowerte}{Lower bound of study 95% relative risk-based confidence interval}
#'   \item{upperte}{Upper bound of study 95% relative risk-based confidence interval}
#' }
#' @section References:
